...
class State(Value):
    ...
    def print_state(self):
        ...
        print('Current Lap Time: ', self.current_lap_time)
        print('Damage: ', self.damage)
        print('Distance from start: ', self.distance_from_start)
        print('Distance Raced: ', self.distance_raced)
        print('Fuel: ', self.fuel)
        print('Gear: ', self.gear)
        print('Last Lap Time: ', self.last_lap_time)
        print('Opponents: ', self.opponents)
        print('Race Position: ', self.race_position)
        print('RPM: ', self.rpm)
        print('Speed_X: ', self.speed_x)
        print('Speed_Y: ', self.speed_y)
        print('Speed_Z: ', self.speed_z)
        print('Distances from Edge: ', self.distances_from_edge)
        print('Distance from center: ', self.distance_from_center)
        print('Wheel Velocities: ', self.wheel_velocities)
